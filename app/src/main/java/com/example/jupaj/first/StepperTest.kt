...
import com.example.jupaj.first.AdafruitMotorHat
/**
...
class StepperTest {
    ...
    fun run(motorNum: Int) {
        ...
        myStepper.step(300, AdafruitMotorHat.FORWARD, AdafruitMotorHat.SINGLE)
        waitFor(1000)
       Log.d(LOG_TAG, "Single coil steps BACKWARD")
        myStepper.step(100, AdafruitMotorHat.BACKWARD, AdafruitMotorHat.SINGLE)
        waitFor(1000)
